/*
(function($){
	var canvas = $('#background_VEILLE_id').children('canvas'),
		background = canvas[0],
				...
				for (var i=0; i<config.circle.amount/config.circle.layer; i++){
					for (var j=0; j<config.circle.layer; j++){
						circles.push({
							x: M.random() * wWidth,
							y: M.random() * wHeight,
							radius: M.random()*(10+j*2.5)+(10+j*2.5),
...
$('.VEILLE_POPUP_JURI').click(function(){
  var buttonId = $(this).attr('id');
  $('#modal-container_juri').removeAttr('class').addClass(buttonId);
  $('#background_VEILLE_id').addClass('modal-active');
})

$('#modal-container_juri').click(function(){
  $(this).addClass('out');
  $('#background_VEILLE_id').removeClass('modal-active');
});


$('.VEILLE_POPUP_INFO').click(function(){
  var buttonId = $(this).attr('id');
  $('#modal-container_info').removeAttr('class').addClass(buttonId);
  $('#background_VEILLE_id').addClass('modal-active');
})

$('#modal-container_info').click(function(){
  $(this).addClass('out');
  $('#background_VEILLE_id').removeClass('modal-active');
});
