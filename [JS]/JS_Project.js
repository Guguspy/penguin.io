...
document.getElementById("CypherNoteMaj").onclick = function() {
    window.open("");
}

document.getElementById("CypherSourceCode").onclick = function() {
    window.open("");
}

document.getElementById("OTPNoteMaj").onclick = function() {
    window.open("");
}

document.getElementById("OTPSourceCode").onclick = function() {
    window.open("");
}
