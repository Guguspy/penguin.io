...
document.getElementById("HMCDC").onclick = function() {
    window.open("[CSS]/[DOCS]/Cahier%20des%20charges%20-%20Hardawre%20Monitor.pdf");
}
document.getElementById("HMDocUser").onclick = function() {
    window.open("[CSS]/[DOCS]/Documentation%20utilisateur%20-%20HardWare%20Monitor.pdf");
}
...
document.getElementById("CryptoCurrencySourceCode").onclick = function() {
    window.open("");
}


document.getElementById("SendBilanNoteMaj").onclick = function() {
    window.open("");
}

document.getElementById("SendBilanSourceCode").onclick = function() {
    window.open("");
}

document.getElementById("SendDevisNoteMaj").onclick = function() {
    window.open("");
}


document.getElementById("SendDevisSourceCode").onclick = function() {
    window.open("");
}

document.getElementById("AttestationNoteMaj").onclick = function() {
    window.open("https://github.com/Guguspy/attestation/blob/master/Notes_MAJ.txt");
}

document.getElementById("AttestationSourceCode").onclick = function() {
    window.open("https://github.com/Guguspy/attestation");
}


document.getElementById("PlanningPHPContext").onclick = function() {
    window.open("[CSS]/[DOCS]/Context_-_MG-info.pdf");
}
document.getElementById("PlanningPHPCDC").onclick = function() {
    window.open("[CSS]/[DOCS]/Cahier%20des%20charges%20-%20S_Room.pdf");
}
document.getElementById("PlanningPHPDocUser").onclick = function() {
    window.open("[CSS]/[DOCS]/Documentation%20Utilisateur%20-%20S_Room.pdf");
}
document.getElementById("PlanningPHPDocSI").onclick = function() {
    window.open("[CSS]/[DOCS]/Documentation%20Service%20Informatique%20-%20S_Room.pdf");
}
document.getElementById("PlanningPHPSite").onclick = function() {
    window.open("https://chambery.sioecoris.com/");
}

document.getElementById("GugusAppsourceCode").onclick = function() {
    window.open("");
}
...
document.getElementById("gugusapp_id").onclick = function() {
    document.getElementById("gugusapp_id_popup").style.display = "block";
}
document.getElementById("gugusapp_close_id").onclick = function() {
    document.getElementById("gugusapp_id_popup").style.display = "none";
}
